...
export const AlgebraBalance: React.FC<AlgebraBalanceProps> = ({
    target = 15,
    constant = 5,
    multiplier = 2,
    variableName = 'x'
    ...
    const currentLeft = (xValue * multiplier) + constant;
    ...
    return (
        <div className="bg-gray-50 rounded-2xl p-8 my-8 border border-gray-100 shadow-inner overflow-hidden">
            <div className="text-center mb-10">
                ...
                <p className="text-gray-600 font-medium">Find the value of <span className="text-blue-600 font-bold">{variableName}</span> that balances the scale.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-200 flex flex-col items-center gap-6">
                <div className="flex items-center gap-8">
                    <div className="text-center">
                        <span className="block text-xs font-black text-gray-400 uppercase tracking-widest mb-2">Value of {variableName.toUpperCase()}</span>
                ...
                <div className="text-2xl font-black flex items-center gap-4 italic text-center">
                    <span className="text-blue-600">{multiplier}({xValue})</span>
                    {constant !== 0 && (
                        <>
                            <span>+</span>
